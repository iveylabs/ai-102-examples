...
namespace speaking_clock
{
    class Program
    {
        ...
        #region custom
        public static string custom = "you handsome devil";
        #endregion
        static async Task Main(string[] args)
        {
            try
            {
                ...
                string speechSvcKey = configuration["SpeechServiceKey"];
                string speechSvcRegion = configuration["SpeechServiceRegion"];
        ...
        static async Task TellTime()
        {
            ...
            string responseText = $"The time is {now.Hour}:{now.Minute:D2}, {custom}.";
